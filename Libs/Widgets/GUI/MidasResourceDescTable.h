...
{
public:
  QTableWidgetMidas3FolderDescItem(m3do::Folder* modeldata, 
                                     const char* text,
                                     MIDASFields field,
                                     QTableWidgetDescriptionItem::Options options = Tooltip | Editable):
    QTableWidgetDescriptionItem(text, options), modeldata(modeldata)
...
{
public:
  QTableWidgetMidas3ItemDescItem(m3do::Item* modeldata, 
                                 const char* text,
                                 MIDASFields field,
                                 QTableWidgetDescriptionItem::Options options = Tooltip | Editable):
  QTableWidgetDescriptionItem(text, options), modeldata(modeldata)
...
{
public:
  QTableWidgetMidas3BitstreamDescItem(m3do::Bitstream* modeldata, 
                                     const char* text,
                                     MIDASFields field,
                                     QTableWidgetDescriptionItem::Options options = Tooltip | Editable):
  QTableWidgetDescriptionItem(text, options), modeldata(modeldata)
